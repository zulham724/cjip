                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            @foreach(Voyager::actions() as $action)
                                                ...
                                                @endif
                                            @endforeach
                                                <form method="get" action="{{ route('cetak.loi', $data->id) }}">
                                                    {{ csrf_field() }}
                                                    <a type="submit" class="btn btn-sm pull-right" style="background-color: #1dcff2"><i class="icon voyager-file-text"></i>  <span class="hidden-xs hidden-sm">Cetak LoI</span> </a>
                                                </form>
                                        </td>
                                    </tr>
                                    @endforeach
