                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <a href="{{$cp->website}}">
                                            <button class="voyager-mail">Website</button>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{$cp->twitter}}">
                                            <button class="voyager-twitter">Twitter</button>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{$cp->instagram}}">
                                            <button class="voyager-instagram">Instagram</button>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{$cp->facebook}}">
                                            <button class="voyager-instagram">Facebook</button>
                                        </a>
                                    </td>
                                    <td>{{$cp->no_telp}}</td>
