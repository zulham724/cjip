                        ...
                        <div class="panel-body">
                            ...
                            @endphp
                                <div class="form-group col-lg-12" >
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" name="komoditas_id" tabindex="-1" aria-hidden="true" @if($edit) value="{{$pertanian->potensiId->jenis_komoditas}}" @endif>
                                ...
                                <div class="form-group col-lg-6" >
                                    ...
                                    <input required type="text" class="form-control" name="tahun" placeholder="Tahun" @if($edit) value="{{$pertanian->tahun}}" @endif>
                                </div>
                                <div class="form-group col-lg-6" >
                                    <label class="control-label">Sumber Data</label>
                                    <input required type="text" class="form-control" name="sumber_data" placeholder="Sumber Data" @if($edit) value="{{$pertanian->sumber_data}}" @endif>
                                </div>
                                ...
                                <div class="form-group col-lg-6" >
                                    ...
                                    <input required type="text" class="form-control" name="luas_tanah" placeholder="Luas Tanah"
                                           @if($edit)
                                           @php
                                               $luas = json_decode($pertanian->luas_tanah, true);
                                           @endphp
                                ...
                                <div class="form-group col-lg-6" >
                                    ...
                                    <input required type="text" class="form-control" name="jml_produksi" placeholder="Jumlah Produksi"
                                           @if($edit)
                                           @php
                                               $jml = json_decode($pertanian->jml_produksi, true);
                                           @endphp
                                ...
                                <div class="form-group col-lg-6" >
                                    ...
                                    <input required type="text" class="form-control" name="produktifitas" placeholder="Produktifitas"
                                           @if($edit)
                                           @php
                                               $prod = json_decode($pertanian->produktifitas, true);
                                           @endphp
