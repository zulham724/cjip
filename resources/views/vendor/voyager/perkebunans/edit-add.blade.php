                        ...
                        <div class="panel-body">
                            ...
                            @endphp
                                <div class="form-group col-lg-12" >
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" name="komoditas_id" tabindex="-1" aria-hidden="true" @if($edit) value="{{$perkebunan->potensiId->jenis_komoditas}}" @endif>
                                        @if($edit)
                                            <option value="{{$perkebunan->komoditas_id}}">{{$perkebunan->potensiId->jenis_komoditas}}</option>
                                            @else
                                ...
                                <div class="form-group col-lg-6" >
                                    ...
                                    <input required type="text" class="form-control" name="tahun" placeholder="Tahun" @if($edit) value="{{$perkebunan->tahun}}" @endif>
                                </div>
                                <div class="form-group col-lg-6" >
                                    <label class="control-label">Sumber Data</label>
                                    <input required type="text" class="form-control" name="sumber_data" placeholder="Sumber Data" @if($edit) value="{{$perkebunan->sumber_data}}" @endif>
                                </div>

                                <div class="form-group col-lg-6" >
                                    <label class="control-label">Luas Tanah</label>
                                    <input required type="text" class="form-control" name="luas_tanah" placeholder="Luas Tanah"
                                           @if($edit)
                                           @php
                                               $luas = json_decode($perkebunan->luas_tanah, true);
                                           @endphp
                                           value="{{$luas['luas_tanah']}}"
                                            @endif>
                                </div>
                                <div class="form-group col-lg-6" >
                                ...
                                <div class="form-group col-lg-6" >
                                    ...
                                    <input required type="text" class="form-control" name="jml_produksi" placeholder="Jumlah Produksi"
                                           @if($edit)
                                           @php
                                               $jml = json_decode($perkebunan->jml_produksi, true);
                                           @endphp
                                           value="{{$jml['jml_produktifitas']}}"
                                        @endif
                                    >
                                </div>
                                <div class="form-group col-lg-6" >
                                ...
                                <div class="form-group col-lg-6" >
                                    ...
                                    <input required type="text" class="form-control" name="produktifitas" placeholder="Produktifitas"
                                           @if($edit)
                                           @php
                                               $prod = json_decode($perkebunan->produktifitas, true);
                                           @endphp
                                           value="{{$prod['produktifitas']}}"
                                        @endif
                                    >
                                </div>
                                <div class="form-group col-lg-6" >
