                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-condensed table-bordered" style="background-color: transparent !important;text-align: center">
                                <tr style="background-color: deepskyblue">
                                    <th style="text-align: center !important;align-items: center; font-weight: bold; color: #781021">Kecamatan</th>
                                    <th style="text-align: center !important;align-items: center; font-weight: bold; color: #781021">Pria</th>
                                    <th style="text-align: center !important;align-items: center; font-weight: bold; color: #781021">Wanita</th>
                                </tr>
                                    ...
                                    <tr>
                                           <td>
                                               <div class="form-group col-md-12">
                                                   <input name="address[{{$loop->iteration}}][kecamatan]" class="form-control" value="{{$k->nama_kecamatan}}" />
                                               </div>
                                           </td>
                                           <td>
                                               <div class="form-group col-md-12">
                                                   <input name="address[{{$loop->iteration}}][pria]"  class="form-control"  />
                                               </div>
                                           </td>
                                           <td>
                                               <div class="form-group col-md-12">
                                                   <input name="address[{{$loop->iteration}}][wanita]" class="form-control"  />
                                               </div>
                                           </td>

                                        <input type="hidden" name="address[{{$loop->iteration}}][user]" value="{{Auth::user()->id}}">
                                    </tr>
                                    @endforeach
                                <tr>
                                    <td>
                                        <div class="form-group col-md-12">
                                            ...
                                            <input name="sumber_data" class="form-control"  />
                                        </div>
                                    </td>
                                </tr>
