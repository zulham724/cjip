        ...
        <section class="development">
            <div class="container" >
                <div class="row" style="background-image: url('{{asset('mail/img/bg-2.png')}}');background-position: center center;
                    ...
                    <div class="col-md-8 col-sm-12" style="padding-top: 300px">
                        <div style="background: #fff none repeat scroll 0 0;margin-left: 35px;margin-top: 0px;box-shadow: -9px 1px 15px rgba(0, 0, 0, 0.1);border-radius: 7px;">
