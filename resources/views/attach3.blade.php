       ...
       padding-top: 32px; padding-left: 8px; padding-right: 8px; padding-bottom: 20px" bgcolor="#ffffff">
              ...
              mso-table-rspace: 0; width: 100%; max-width: 400px; border: solid 2px #e5f0ff;">
                    ...
                    color: #7d93b2; padding-left: 16px; padding-top: 16px; margin-top: 0; margin-bottom: 0;">
                                ...
                                <td align="center" style="vertical-align: top; padding-top: 16px; " valign="top">
                                    <p style="background-color: #e5f0ff; text-align: center; font-size: 14px; font-family: sans-serif;
